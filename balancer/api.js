...
module.exports = {
        ...
        client.call("linode.create", {DatacenterID: location, PlanID: plan}, function(e, r) {
            if (e == undefined) {
                ...
                var region = regions.find(function(o) {
                    return o.name == locationName;
                });
                var options = {
                    cron: cron(region.hour),
                                            ...
                                            client.call("linode.boot", {LinodeID: id, ConfigID: config}, function(e, r) {
                                                if (e == undefined) {
                                                    ...
                                                    client.call("linode.ip.list", {LinodeID: id}, function(e, r) {
                                                        ...
                                                        if (e == undefined) {
                                                            sl.add(locationName, ip);
															sl.incrementHour(locationName);
                                                            callback(null, id, ip);
                                                        } else {
    ...
    destroy: function(locationName, which, c) {
        var regions = sl.get();
        var region = regions.find(function(o) {
            return o.name == locationName;
        });
		...
		if (ip != null) {
	        if (which.indexOf(".") < 0) {
	            ip = region.servers[Number(which)];
	        }
		} else {
...
function cron(n) {
    return "0 " + n + " * * * /bin/game-update && /bin/game-drain";
}
